    ...
    <Card className="mx-auto flex w-full max-w-6xl flex-col md:flex-row">
      ...
      <div
        className={mergeClasses(
          'flex items-center justify-center border-gray-100 bg-gray-50 p-8 dark:bg-gray-200 max-md:rounded-t-xl md:w-1/2 lg:p-10',
          layoutType === 'default'
      ...
      <div
        className={mergeClasses(
          'flex flex-col gap-6 p-8 md:w-1/2 lg:p-10',
